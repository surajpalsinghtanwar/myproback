                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row no-gutters mt-3">
                                ...
                                <div class="col-10">
                                    <ul class="inline-links">
                                        <li>
                                            <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ static_asset('frontend/images/icons/cards/visa.png') }}" width="30" class="lazyload">
                                        </li>
                                        <li>
                                            <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ static_asset('frontend/images/icons/cards/mastercard.png') }}" width="30" class="lazyload">
                                        </li>
                                        <li>
                                            <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ static_asset('frontend/images/icons/cards/maestro.png') }}" width="30" class="lazyload">
                                        </li>
                                        <li>
                                            <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ static_asset('frontend/images/icons/cards/paypal.png') }}" width="30" class="lazyload">
                                        </li>
                                        <li>
                                            <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ static_asset('frontend/images/icons/cards/cod.png') }}" width="30" class="lazyload">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            {{-- <div class="row no-gutters mt-3">
                                <div class="col-2">
                                    <img loading="lazy"  src="{{ static_asset('frontend/images/icons/buyer-protection.png') }}" width="40" class="">
                                </div>
                                <div class="col-10">
                                        ...
                                        @foreach ($detailedProduct->reviews as $key => $review)
                                            <div class="block block-comment">
                                                <div class="block-image">
                                                    <img src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($review->user->avatar_original) }}" class="rounded-circle lazyload">
                                                </div>
                                        ...
                                        <div class="col-5">
                                            <div class="position-relative overflow-hidden h-100">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center">
                                                    <img class="img-fit lazyload" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($related_product->thumbnail_img) }}" alt="{{  translate($related_product->name) }}">
                                                </a>
                                            </div>
                                        </div>
